...
def step_a_load_data(
    ...
    Step A: Load data
    - Load reference dataset by month and year
    - Load batch dataset by month and year
    ...
    Args:
        ...
        ref_year: Reference dataset year (e.g., '2020')
        batch_year: Batch dataset year (e.g., '2020')
    ...
    # Get file paths
    ref_path = get_taxi_files(data_dir, ref_month, ref_year)
    batch_path = get_taxi_files(data_dir, batch_month, batch_year)
    ...
    mlflow.log_param("ref_year", ref_year)
    mlflow.log_param("batch_month", batch_month)
    mlflow.log_param("batch_year", batch_year)
